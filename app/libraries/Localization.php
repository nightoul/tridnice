...
class Localization {
  ...
  private static $error_message_translations = [
    'en' => [
        ...
        'err_password' => 'Type the password.',
        'err_password_invalid' => 'The password must have at least 6 characters.',
        'err_confirm_password' => 'Type the password again.',
    ...
    'cz' => [
        ...
        'err_password' => 'Zadejte prosím heslo.',
        'err_password_invalid' => 'Heslo musí mít aspoň 6 znaků.',
        'err_confirm_password' => 'Zadejte heslo znovu pro kontrolu.',
        'err_password_match' => 'Hesla se neshodují.',
        'err_password_incorrect' => 'Nesprávné heslo.',
  ...
  private static $success_message_translations = [
    ...
    'cz' => [
      ...
      'success_change_password' => 'Právě jste změnili heslo.',
